...
//go:generate minimock -i github.com/spv-dev/auth/internal/service.UserService -o user_service_minimock.go -n UserServiceMock -p mocks
...
type UserServiceMock struct {
	...
	funcUpdateUser          func(ctx context.Context, id int64, info *model.UpdateUserInfo) (err error)
	funcUpdateUserOrigin    string
	inspectFuncUpdateUser   func(ctx context.Context, id int64, info *model.UpdateUserInfo)
...
func (mmCreateUser *mUserServiceMockCreateUser) Expect(ctx context.Context, info *model.UserInfo, password string) *mUserServiceMockCreateUser {
	...
	mmCreateUser.defaultExpectation.params = &UserServiceMockCreateUserParams{ctx, info, password}
...
// ExpectInfoParam2 sets up expected param info for UserService.CreateUser
func (mmCreateUser *mUserServiceMockCreateUser) ExpectInfoParam2(info *model.UserInfo) *mUserServiceMockCreateUser {
	if mmCreateUser.mock.funcCreateUser != nil {
		mmCreateUser.mock.t.Fatalf("UserServiceMock.CreateUser mock is already set by Set")
	}
...
// ExpectPasswordParam3 sets up expected param password for UserService.CreateUser
func (mmCreateUser *mUserServiceMockCreateUser) ExpectPasswordParam3(password string) *mUserServiceMockCreateUser {
	if mmCreateUser.mock.funcCreateUser != nil {
		mmCreateUser.mock.t.Fatalf("UserServiceMock.CreateUser mock is already set by Set")
	}
...
func (mmCreateUser *mUserServiceMockCreateUser) Inspect(f func(ctx context.Context, info *model.UserInfo, password string)) *mUserServiceMockCreateUser {
...
func (mmCreateUser *mUserServiceMockCreateUser) Set(f func(ctx context.Context, info *model.UserInfo, password string) (i1 int64, err error)) *UserServiceMock {
	if mmCreateUser.defaultExpectation != nil {
...
// Then helper
func (mmCreateUser *mUserServiceMockCreateUser) When(ctx context.Context, info *model.UserInfo, password string) *UserServiceMockCreateUserExpectation {
	if mmCreateUser.mock.funcCreateUser != nil {
		mmCreateUser.mock.t.Fatalf("UserServiceMock.CreateUser mock is already set by Set")
	}
	...
	expectation := &UserServiceMockCreateUserExpectation{
		...
		params:             &UserServiceMockCreateUserParams{ctx, info, password},
...
func (mmCreateUser *UserServiceMock) CreateUser(ctx context.Context, info *model.UserInfo, password string) (i1 int64, err error) {
	...
	mm_params := UserServiceMockCreateUserParams{ctx, info, password}
	...
	if mmCreateUser.CreateUserMock.defaultExpectation != nil {
		...
		mm_got := UserServiceMockCreateUserParams{ctx, info, password}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.info != nil && !minimock.Equal(*mm_want_ptrs.info, mm_got.info) {
				mmCreateUser.t.Errorf("UserServiceMock.CreateUser got unexpected parameter info, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
			...
			if mm_want_ptrs.password != nil && !minimock.Equal(*mm_want_ptrs.password, mm_got.password) {
				mmCreateUser.t.Errorf("UserServiceMock.CreateUser got unexpected parameter password, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
	...
	mmCreateUser.t.Fatalf("Unexpected call to UserServiceMock.CreateUser. %v %v %v", ctx, info, password)
	return
}
...
func (mmGetUser *mUserServiceMockGetUser) Return(u1 model.User, err error) *UserServiceMock {
	if mmGetUser.mock.funcGetUser != nil {
		mmGetUser.mock.t.Fatalf("UserServiceMock.GetUser mock is already set by Set")
	}
	...
	mmGetUser.defaultExpectation.results = &UserServiceMockGetUserResults{u1, err}
...
func (mmGetUser *mUserServiceMockGetUser) Set(f func(ctx context.Context, id int64) (u1 model.User, err error)) *UserServiceMock {
	if mmGetUser.defaultExpectation != nil {
...
func (e *UserServiceMockGetUserExpectation) Then(u1 model.User, err error) *UserServiceMock {
	e.results = &UserServiceMockGetUserResults{u1, err}
	return e.mock
}
...
func (mmGetUser *UserServiceMock) GetUser(ctx context.Context, id int64) (u1 model.User, err error) {
...
func (mmUpdateUser *mUserServiceMockUpdateUser) Expect(ctx context.Context, id int64, info *model.UpdateUserInfo) *mUserServiceMockUpdateUser {
	...
	mmUpdateUser.defaultExpectation.params = &UserServiceMockUpdateUserParams{ctx, id, info}
...
// ExpectInfoParam3 sets up expected param info for UserService.UpdateUser
func (mmUpdateUser *mUserServiceMockUpdateUser) ExpectInfoParam3(info *model.UpdateUserInfo) *mUserServiceMockUpdateUser {
	if mmUpdateUser.mock.funcUpdateUser != nil {
		mmUpdateUser.mock.t.Fatalf("UserServiceMock.UpdateUser mock is already set by Set")
	}
...
func (mmUpdateUser *mUserServiceMockUpdateUser) Inspect(f func(ctx context.Context, id int64, info *model.UpdateUserInfo)) *mUserServiceMockUpdateUser {
...
func (mmUpdateUser *mUserServiceMockUpdateUser) Set(f func(ctx context.Context, id int64, info *model.UpdateUserInfo) (err error)) *UserServiceMock {
	if mmUpdateUser.defaultExpectation != nil {
...
// Then helper
func (mmUpdateUser *mUserServiceMockUpdateUser) When(ctx context.Context, id int64, info *model.UpdateUserInfo) *UserServiceMockUpdateUserExpectation {
	if mmUpdateUser.mock.funcUpdateUser != nil {
		mmUpdateUser.mock.t.Fatalf("UserServiceMock.UpdateUser mock is already set by Set")
	}
	...
	expectation := &UserServiceMockUpdateUserExpectation{
		...
		params:             &UserServiceMockUpdateUserParams{ctx, id, info},
...
func (mmUpdateUser *UserServiceMock) UpdateUser(ctx context.Context, id int64, info *model.UpdateUserInfo) (err error) {
	...
	mm_params := UserServiceMockUpdateUserParams{ctx, id, info}
	...
	if mmUpdateUser.UpdateUserMock.defaultExpectation != nil {
		...
		mm_got := UserServiceMockUpdateUserParams{ctx, id, info}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.info != nil && !minimock.Equal(*mm_want_ptrs.info, mm_got.info) {
				mmUpdateUser.t.Errorf("UserServiceMock.UpdateUser got unexpected parameter info, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
	...
	mmUpdateUser.t.Fatalf("Unexpected call to UserServiceMock.UpdateUser. %v %v %v", ctx, id, info)
	return
}
