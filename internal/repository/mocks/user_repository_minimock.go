...
//go:generate minimock -i github.com/spv-dev/auth/internal/repository.UserRepository -o user_repository_minimock.go -n UserRepositoryMock -p mocks
...
type UserRepositoryMock struct {
	...
	funcUpdateUser          func(ctx context.Context, id int64, user *model.UpdateUserInfo) (err error)
	funcUpdateUserOrigin    string
	inspectFuncUpdateUser   func(ctx context.Context, id int64, user *model.UpdateUserInfo)
...
func (mmCreateUser *mUserRepositoryMockCreateUser) Expect(ctx context.Context, info *model.UserInfo, password string) *mUserRepositoryMockCreateUser {
	...
	mmCreateUser.defaultExpectation.params = &UserRepositoryMockCreateUserParams{ctx, info, password}
...
// ExpectInfoParam2 sets up expected param info for UserRepository.CreateUser
func (mmCreateUser *mUserRepositoryMockCreateUser) ExpectInfoParam2(info *model.UserInfo) *mUserRepositoryMockCreateUser {
	if mmCreateUser.mock.funcCreateUser != nil {
		mmCreateUser.mock.t.Fatalf("UserRepositoryMock.CreateUser mock is already set by Set")
	}
...
// ExpectPasswordParam3 sets up expected param password for UserRepository.CreateUser
func (mmCreateUser *mUserRepositoryMockCreateUser) ExpectPasswordParam3(password string) *mUserRepositoryMockCreateUser {
	if mmCreateUser.mock.funcCreateUser != nil {
		mmCreateUser.mock.t.Fatalf("UserRepositoryMock.CreateUser mock is already set by Set")
	}
...
func (mmCreateUser *mUserRepositoryMockCreateUser) Inspect(f func(ctx context.Context, info *model.UserInfo, password string)) *mUserRepositoryMockCreateUser {
...
func (mmCreateUser *mUserRepositoryMockCreateUser) Set(f func(ctx context.Context, info *model.UserInfo, password string) (i1 int64, err error)) *UserRepositoryMock {
	if mmCreateUser.defaultExpectation != nil {
...
// Then helper
func (mmCreateUser *mUserRepositoryMockCreateUser) When(ctx context.Context, info *model.UserInfo, password string) *UserRepositoryMockCreateUserExpectation {
	if mmCreateUser.mock.funcCreateUser != nil {
		mmCreateUser.mock.t.Fatalf("UserRepositoryMock.CreateUser mock is already set by Set")
	}
	...
	expectation := &UserRepositoryMockCreateUserExpectation{
		...
		params:             &UserRepositoryMockCreateUserParams{ctx, info, password},
...
func (mmCreateUser *UserRepositoryMock) CreateUser(ctx context.Context, info *model.UserInfo, password string) (i1 int64, err error) {
	...
	mm_params := UserRepositoryMockCreateUserParams{ctx, info, password}
	...
	if mmCreateUser.CreateUserMock.defaultExpectation != nil {
		...
		mm_got := UserRepositoryMockCreateUserParams{ctx, info, password}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.info != nil && !minimock.Equal(*mm_want_ptrs.info, mm_got.info) {
				mmCreateUser.t.Errorf("UserRepositoryMock.CreateUser got unexpected parameter info, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
			...
			if mm_want_ptrs.password != nil && !minimock.Equal(*mm_want_ptrs.password, mm_got.password) {
				mmCreateUser.t.Errorf("UserRepositoryMock.CreateUser got unexpected parameter password, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
	...
	mmCreateUser.t.Fatalf("Unexpected call to UserRepositoryMock.CreateUser. %v %v %v", ctx, info, password)
	return
}
...
func (mmGetUser *mUserRepositoryMockGetUser) Return(u1 model.User, err error) *UserRepositoryMock {
	if mmGetUser.mock.funcGetUser != nil {
		mmGetUser.mock.t.Fatalf("UserRepositoryMock.GetUser mock is already set by Set")
	}
	...
	mmGetUser.defaultExpectation.results = &UserRepositoryMockGetUserResults{u1, err}
...
func (mmGetUser *mUserRepositoryMockGetUser) Set(f func(ctx context.Context, id int64) (u1 model.User, err error)) *UserRepositoryMock {
	if mmGetUser.defaultExpectation != nil {
...
func (e *UserRepositoryMockGetUserExpectation) Then(u1 model.User, err error) *UserRepositoryMock {
	e.results = &UserRepositoryMockGetUserResults{u1, err}
	return e.mock
}
...
func (mmGetUser *UserRepositoryMock) GetUser(ctx context.Context, id int64) (u1 model.User, err error) {
...
func (mmUpdateUser *mUserRepositoryMockUpdateUser) Expect(ctx context.Context, id int64, user *model.UpdateUserInfo) *mUserRepositoryMockUpdateUser {
	...
	mmUpdateUser.defaultExpectation.params = &UserRepositoryMockUpdateUserParams{ctx, id, user}
...
// ExpectUserParam3 sets up expected param user for UserRepository.UpdateUser
func (mmUpdateUser *mUserRepositoryMockUpdateUser) ExpectUserParam3(user *model.UpdateUserInfo) *mUserRepositoryMockUpdateUser {
	if mmUpdateUser.mock.funcUpdateUser != nil {
		mmUpdateUser.mock.t.Fatalf("UserRepositoryMock.UpdateUser mock is already set by Set")
	}
...
func (mmUpdateUser *mUserRepositoryMockUpdateUser) Inspect(f func(ctx context.Context, id int64, user *model.UpdateUserInfo)) *mUserRepositoryMockUpdateUser {
...
func (mmUpdateUser *mUserRepositoryMockUpdateUser) Set(f func(ctx context.Context, id int64, user *model.UpdateUserInfo) (err error)) *UserRepositoryMock {
	if mmUpdateUser.defaultExpectation != nil {
...
// Then helper
func (mmUpdateUser *mUserRepositoryMockUpdateUser) When(ctx context.Context, id int64, user *model.UpdateUserInfo) *UserRepositoryMockUpdateUserExpectation {
	if mmUpdateUser.mock.funcUpdateUser != nil {
		mmUpdateUser.mock.t.Fatalf("UserRepositoryMock.UpdateUser mock is already set by Set")
	}
	...
	expectation := &UserRepositoryMockUpdateUserExpectation{
		...
		params:             &UserRepositoryMockUpdateUserParams{ctx, id, user},
...
func (mmUpdateUser *UserRepositoryMock) UpdateUser(ctx context.Context, id int64, user *model.UpdateUserInfo) (err error) {
	...
	mm_params := UserRepositoryMockUpdateUserParams{ctx, id, user}
	...
	if mmUpdateUser.UpdateUserMock.defaultExpectation != nil {
		...
		mm_got := UserRepositoryMockUpdateUserParams{ctx, id, user}
	...
	mmUpdateUser.t.Fatalf("Unexpected call to UserRepositoryMock.UpdateUser. %v %v %v", ctx, id, user)
	return
}
